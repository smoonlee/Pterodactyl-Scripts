...
echo ""
read -p "Paste Here: " PanelRepo#!/bin/bash
#
# Pterodactyl Web Panel Setup Script
# Author: Simon Lee
# Twitter @smoon_lee
...
echo " Copy the link for the panel.tar.gz and paste below!"
echo ""
read -p "Paste Here: " PanelDownload
curl -Lo panel.tar.gz $PanelDownload
...
echo "=============================="
wget https://raw.githubusercontent.com/smoonlee/pterodactyl/master/current/ubuntu/pteroq.service -O /etc/systemd/system/pteroq.service
